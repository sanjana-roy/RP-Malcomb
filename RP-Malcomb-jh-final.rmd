...
diffmap_2010 = ggplot() +
  ...
  scale_fill_manual(
    ...
    values = c(
      "Missing Data" = "#404040",
      "National Parks and Reserves" = "#78c679",
      "Major Lakes of Malawi" = "#74A9CF",
      "-2" = "#7b3294",
      "-1" = "#c2a5cf",
      "0" = "#CCCCCC",
      "1" = "#e66101")
...
orfig5vect = 
  read_sf(here("data", "derived", "public", "georeferencing5.gpkg"), 
          layer="fig5_tas")
...
scatterplot = plot(fig5comppts$or, fig5comppts$rp, xlab="Original Study", ylab="Reproduction")
...
diffvuln_map = ggplot() +
  ...
  scale_fill_gradient(
    ...
    high = "#3f007d",
    breaks = c(-0.9, 0.6),
    labels = c("Greater Original Value", "Greater Reproduced Value"),
    na.value = "transparent",
    guide = "colourbar",
    limits = c(-0.9, 0.6)
  ) +
...
save(scatterplot, diffmap_2010, diffvuln_map, file = here("results","maps","maps.Rdata"))

ggsave(
  here("results","maps","scatterplot.png"),
  plot = scatterplot,
  width = 11,
  height = 8.5,
  units = "in"
...
ggsave(
  here("results","maps","diffmap2010.png"),
  plot = diffmap_2010,
  width = 8.5,
  height = 11,
  units = "in"
...
ggsave(
  here("results","maps","diffmapvuln.png"),
  plot = diffvuln_map,
  width = 8.5,
  height = 11,
  units = "in"
